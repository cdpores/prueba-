...
class Administrador extends Conexion{
  ...
  public function actualizar($idAdministrador, $nombreAdministrador, $apellidoAdministrador, $telefonoAdministrador, $nitEmpresa){
    $editar=$this->db->prepare("UPDATE Administrador SET idAdministrador=:idAdministrador, nombreAdministrador=:nombreAdministrador, apellidoAdministrador=:apellidoAdministrador, telefonoAdministrador=:telefonoAdministrador, nitEmpresa=:nitEmpresa
